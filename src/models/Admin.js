...
const adminSchema = new mongoose.Schema(
  {
    ...
    role: {
      type: String,
      enum: ["admin", "super_admin", "salon-admin", "specialist", "support"],
      default: "admin",
    },
    specialistId: {
...
// Apply multi-tenant plugin (not required for super_admin)
adminSchema.plugin(multiTenantPlugin, { required: false });

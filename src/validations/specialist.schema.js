...
export const createSpecialistSchema = baseSpecialistSchema;

// Update specialist schema (PATCH) - all fields optional
export const updateSpecialistSchema = baseSpecialistSchema.partial();
 ...
 */
export function validateCreateSpecialist(data) {
  try {
    const validated = createSpecialistSchema.parse(data);
 ...
 * @returns {{ success: true, data: object } | { success: false, errors: array }}
 */
export function validateUpdateSpecialist(data) {
  try {
    const validated = updateSpecialistSchema.parse(data);
    return { success: true, data: validated };
  } catch (err) {
    if (err instanceof z.ZodError) {
      return {
